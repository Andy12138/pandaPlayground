package com.zmg.panda.conf.websocket;

import com.zmg.panda.manage.websocket.MyPrincipalHandshakeHandler;
import com.zmg.panda.manage.websocket.WebsocketChannelInterceptor;
import com.zmg.panda.manage.websocket.WebsocketHandshakeInterceptor;
...
public class WebsocketStompConf implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
                // 端点
        registry.addEndpoint("/api/websocket/server")
                // 可跨域
                .setAllowedOrigins("*")
                // 自定义拦截器
